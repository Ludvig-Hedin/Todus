...
// GetThreadResponse / FailableDecodable / EmailThreadDetail live in
// Domain/EmailThreadResponse.swift (Foundation-only) so the decode-tolerance tests
// compile them standalone without the MLX-linked host. See MAC-1.
