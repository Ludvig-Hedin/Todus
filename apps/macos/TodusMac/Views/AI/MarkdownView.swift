    ...
    static func parse(_ content: String) -> [MarkdownBlock] {
        ...
        while i < lines.count {
            ...
            while i < lines.count {
                ...
                if isULItem(t) || isOLItem(t) { break }
                if t == "---" || t == "***" || t == "___" { break }
...
private struct MarkdownBlockView: View {
    ...
    var body: some View {
        Group {
            ...
            case .codeBlock(let lang, let code):
                ...
                .background(Color.primary.opacity(0.06), in: RoundedRectangle(cornerRadius: MacTheme.compactRadius, style: .continuous))
                .padding(.top, isFirst ? 0 : 10)
    ...
    private func headingFont(_ level: Int) -> Font {
        switch level {
        case 1: return .system(size: fontSize + 5, weight: .bold)
        case 2: return .system(size: fontSize + 2, weight: .semibold)
