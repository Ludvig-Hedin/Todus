...
/// Settings view — account info, connected services, preferences, about.
/// Desktop-optimized: native macOS Form with grouped sections.
    ...
    private var avatarFallback: some View {
        ZStack {
            Circle()
                ...
                .frame(width: 40, height: 40)
            if let email = services.authService.userEmail, let first = email.first {
