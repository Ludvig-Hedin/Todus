...
export default [
  ...
  layout('(full-width)/layout.tsx', [
    ...
    route('/downloads', '(full-width)/downloads.tsx'),
    route('/contact', '(full-width)/contact.tsx'),
    route('/faq', '(full-width)/faq.tsx'),
  ...
  layout('(routes)/layout.tsx', [
    ...
    layout(
      ...
      prefix('/settings', [
        ...
        route('/local-models', '(routes)/settings/local-models/page.tsx'),
        route('/billing', '(routes)/settings/billing/page.tsx'),
        route('/calendars', '(routes)/settings/calendars/page.tsx'),
        route('/about', '(routes)/settings/about/page.tsx'),
        route('/design-system', '(routes)/settings/design-system/page.tsx'),
