...
enum SenderIconRegistry {

    static func icon(for email: String) -> SenderIconSpec? {
    ...
    private static let icons: [String: SenderIconSpec] = {
        var d: [String: SenderIconSpec] = [:]
