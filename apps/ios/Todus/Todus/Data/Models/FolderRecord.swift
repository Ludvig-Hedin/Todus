...
final class FolderRecord: Identifiable {
    ...
    // Cached summary used by folder cards so they render instantly and offline.
    // Refreshed by TaskCaptureService.fetchFolderSummary(in:).
...
struct FolderRecentItem: Codable, Equatable, Identifiable {
    var type: String   // "task" | "chat" | "email" | "event" | "doc"
    var id: String
    var title: String
    var subtitle: String?
    var sortAt: Date
