...
export const AppleLogo = (props: SvgProps) => (
  <Svg viewBox="0 0 24 24" {...props}>
    <Path
      fill="currentColor"
      d="M16.68 12.54c.02 2.15 1.88 2.87 1.9 2.88c-.02.05-.3 1.03-.98 2.05c-.59.88-1.21 1.76-2.17 1.78c-.94.02-1.24-.56-2.32-.56c-1.08 0-1.42.54-2.3.58c-.92.03-1.63-.93-2.22-1.81C7.4 15.74 6.48 12.6 7.74 10.4c.62-1.09 1.74-1.78 2.96-1.8c.9-.02 1.76.61 2.32.61c.56 0 1.6-.76 2.69-.65c.46.02 1.76.19 2.59 1.41c-.07.04-1.55.91-1.53 2.57ZM15.05 7.51c.49-.6.82-1.42.73-2.25c-.71.03-1.57.47-2.08 1.06c-.46.53-.87 1.38-.76 2.19c.79.06 1.61-.4 2.11-1Z"
    />
  </Svg>
);
