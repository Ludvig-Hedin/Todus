...
| --- | --- | --- | --- | --- | --- |
| A | **Calendar write support** | event create/edit/delete UI, multi-calendar visibility toggles | web (server ready) | Low | `2026-06-13-web-calendar-write-support-design.md` |
