        ...
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 md:gap-x-16">
          <div>
            ...
            <p className="md:text-base">
              It doesn't just talk. The AI reads your email, creates tasks, drafts replies, and
            ...
            <div className="mt-6 flex flex-wrap gap-4 md:mt-8">
              ...
              <Button title="See pricing" variant="link" size="link" iconRight={<RxChevronRight />}>
                See pricing
              </Button>
            </div>
          </div>
          <div className="relative flex">
            <div className="absolute left-0 top-[10%] w-1/2">
              <img
                ...
                alt="Assistant suggestions appearing alongside your workspace"
              />
            </div>
            <div className="ml-[30%]">
              <img
                ...
                alt="Expanded Todus assistant workflow preview"
              />
            </div>
          </div>
        </div>
