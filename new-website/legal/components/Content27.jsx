  ...
  return (
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="xxl:gap-x-48 grid grid-cols-1 gap-y-8 lg:grid-cols-[20rem_1fr] lg:gap-x-16">
          <div>
            <div className="lg:sticky lg:top-24">
              ...
              >
                <AccordionItem value="aside-menu" className="border-none">
                  <AccordionTrigger className="border-border-primary flex cursor-pointer items-center justify-between gap-3 border px-4 py-3 lg:pointer-events-none lg:cursor-auto lg:border-none lg:p-0 [&_svg]:size-4 [&_svg]:lg:hidden">
                    <h3 className="text-lg font-bold leading-[1.4] md:text-2xl">What we collect</h3>
                  </AccordionTrigger>
                  <AccordionContent className="pb-0">
                    <div className="mt-3 md:mt-4">
                      <a
                        href="#heading-2"
                        className="block px-4 py-3 md:text-base"
                        style={{ marginLeft: 0 }}
                      >
                        Heading 2
                      </a>
            ...
            <div className="prose md:prose-md lg:prose-lg">
              <Fragment>
                ...
                <p>
                  ...
                  Montes, sed mattis pellentesque suscipit accumsan. Cursus viverra aenean magna
                  risus elementum faucibus molestie pellentesque. Arcu ultricies sed mauris
                  vestibulum.
                </p>
                <h4 id="heading-4">Heading 4</h4>
                <p>
                  Morbi sed imperdiet in ipsum, adipiscing elit dui lectus. Tellus id scelerisque
                  est ultricies ultricies. Duis est sit sed leo nisl, blandit elit sagittis. Quisque
