          ...
          <div>
            <div className="ml-[5%] mr-[10%]">
              <p className="md:text-md">
                All your tasks, emails, and notes are seamlessly updated across
                every platform. Change something on your phone, and it's there
                on your Mac. No lag, no confusion, no manual refresh.
              </p>
